const education = {
  ...
  list: [
    ...
    },
    {
      ...
      graduation: "Técnico em Eletrônica",
      time: "2018-2021",
      additional: [
        "Formou-se em 2021 no curso Técnico Integrado em Eletrônica junto ao Ensino Médio no Instituto Federal da Paraíba, Campus João Pessoa",
      ],
    },
  ],
};
